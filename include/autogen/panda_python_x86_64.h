...
typedef union MMXReg {
    ...
    uint64_t _q_MMXReg[1];
    float32 _s_MMXReg[2];
    float64 _d_MMXReg[1];
} MMXReg;
typedef union XMMReg {
    uint64_t _q_XMMReg[2];
} XMMReg;
typedef union YMMReg {
    uint64_t _q_YMMReg[4];
    XMMReg _x_YMMReg[2];
} YMMReg;
typedef union ZMMReg {
    uint8_t _b_ZMMReg[64];
    uint16_t _w_ZMMReg[32];
    uint32_t _l_ZMMReg[16];
    uint64_t _q_ZMMReg[8];
    float16 _h_ZMMReg[32];
    float32 _s_ZMMReg[16];
    float64 _d_ZMMReg[8];
    XMMReg _x_ZMMReg[4];
    YMMReg _y_ZMMReg[2];
} ZMMReg;
...
extern ExtSaveArea x86_ext_save_areas[19];
...
typedef struct CPUArchState {
   ...
   _Bool 
    ...
    uint64_t msr_gp_counters[18];
    uint64_t msr_gp_evtsel[18];
    uint64_t pat;
    uint32_t smbase;
    ...
    uint64_t msr_hv_crash_params[5];
