...
# panda = Panda(generic=arch)# raw_monitor=True, extra_args=["-serial","telnet:localhost:4321,server,nowait"])
panda = Panda(generic="i386",nproc=16, raw_monitor=True, mem="4G")
